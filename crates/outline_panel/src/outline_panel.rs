...
impl OutlinePanel {
    ...
    fn new(
        ...
        cx.new(|cx| {
            ...
            let mut document_symbols_by_buffer: HashMap<BufferId, settings::DocumentSymbols> =
                HashMap::default();
            let settings_subscription =
                cx.observe_global_in::<SettingsStore>(window, move |outline_panel, window, cx| {
                    ...
                    if !outlines_invalidated {
                        let new_document_symbols: HashMap<BufferId, settings::DocumentSymbols> =
                            outline_panel
                                .excerpts
                                .keys()
                        ...
                        .update_in(cx, |outline_panel, window, cx| {
                            ...
                            for excerpt_id in &excerpt_ids {
                                if let Some(excerpt) = outline_panel
                                    ...
                                    .get_mut(excerpt_id)
                                {
                                    excerpt.outlines = ExcerptOutlines::Outlines(outlines.clone());
    ...
    cx.subscribe_in(
        ...
        move |outline_panel, editor, e: &EditorEvent, window, cx| {
            ...
            match e {
                ...
                EditorEvent::DocumentSymbolsChanged => {
                    for excerpts in outline_panel.excerpts.values_mut() {
                        for excerpt in excerpts.values_mut() {
                            excerpt.invalidate_outlines();
                        }
